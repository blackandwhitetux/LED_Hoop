...
// Pin definitions
int intPin = 3;  // Interrupt pin from MPU9250 to ESP-03 - does esp-03 support external interrupt?
...
#define SPIspeed 1000000 // for MPU9250 
#define SPIport SPI // for MPU9250
#define CSpin   2
#define MPU9250_ADDRESS 9001 // Use any old address value because it is not used for SPI, but it is all over this example
#define FASTLED_FORCE_SOFTWARE_SPI  // can use hardware spi?
#define DATA_PIN      5
#define CLK_PIN     6
